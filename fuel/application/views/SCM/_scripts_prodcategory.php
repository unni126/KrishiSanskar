    ...
    $(function () {
        ...
        $('.delete').click(function () {
            ...
            if (confirm("Are you sure want to delete this item.")) {
                $.ajax({
                    url: '<?php echo site_url('scm/ProductCategory/delete'); ?>',
                    type: 'POST',
                    data: {
                        id: id
                    },
        ...
        $('.view').click(function () {
            var id = $(this).attr('data-value');
            $.ajax({
                url: '<?php echo site_url('scm/ProductCategory/view'); ?>',
                type: 'POST',
                data: {
                    id: id
                },
                ...
                success: function (data) {
                    ...
                    if (data.Image !== '' && data.Image !== null) {
                        var url = "<?php echo base_url(); ?>/uploads/p01/" + data.Image + '.' + data.Ext;
        ...
        $('.flip').click(function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?php echo site_url('scm/ProductCategory/changestatus'); ?>',
                type: 'POST',
                data: {
