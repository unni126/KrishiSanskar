            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/krishisanskar/scm/account/logout/" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/krishisanskar/scm/products"><i class="fa fa-circle-o"></i> Products</a></li>
            <li><a href="/krishisanskar/scm/productcategory"><i class="fa fa-circle-o"></i> Product Categories</a></li>
          </ul>
        </li>
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active">
              <a href="/krishisanskar/scm/mail/inbox">Inbox
                <span class="pull-right-container">
                  <span class="label label-primary pull-right">13</span>
                </span>
              </a>
            </li>
            <li><a href="/krishisanskar/scm/mail/compose">Compose</a></li>
            <li><a href="/krishisanskar/scm/mail/read">Read</a></li>
          </ul>
        </li>
      </ul>
    </section>
